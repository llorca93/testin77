 ...
 */
final class Version20211023181828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD user_id INT NOT NULL, ADD illustration VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP user_id, DROP illustration');
    }
}
